...
/obj/item/integrated_circuit/input/sensor/proc/sense(var/atom/A, mob/user, proximity)
	if(!proximity)
		return FALSE
...
/obj/item/integrated_circuit/input/sensor/ranged/sense(atom/A, mob/user, proximity)
	if(!user || !istype(A))
		return FALSE
